    ...
    <article className="flex flex-col gap-4 rounded-[var(--radius-lg)] border border-[var(--color-border)] bg-[var(--color-surface)] p-4 sm:flex-row">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <div className="flex items-start justify-between gap-3">
          <div>
            <h3 className="text-sm leading-6 font-bold text-[var(--color-text)]">
              {product.title}
            </h3>
          ...
          <Button
            ...
            onClick={() => removeItem(product.id, selectedColor?.value)}
        ...
        <div className="mt-auto flex flex-col gap-4 pt-4 sm:flex-row sm:items-end sm:justify-between">
          <div className="inline-flex h-10 w-fit items-center overflow-hidden rounded-[var(--radius-md)] border border-[var(--color-border)]">
            <Button
              type="button"
              variant="ghost"
              size="icon"
            ...
            <span className="flex h-10 min-w-10 items-center justify-center border-x border-[var(--color-border)] text-sm font-bold">

  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/products" element={<PlaceholderPage title="محصولات" />} />
        ...
        <Route path="/register" element={<PlaceholderPage title="ثبت نام" />} />

        <Route path="/about" element={<PlaceholderPage title="درباره ما" />} />
        ...
        <Route path="/blog/:slug" element={<PlaceholderPage title="مقاله" />} />
